...
EXTEND_BOTTOM DOGHMA 0
	...
	+ ~PartyHasItem("kla#bk01") Global("kla#book01","GLOBAL",2)~
		+ @55 + foundBook0
	// doghma is researching, timer not done
	+ ~Global("kla#book01","GLOBAL",5)
		GlobalTimerNotExpired("kla#book01Timer","GLOBAL")~
		+ @56 + noProgress
	// doghma is researching, timer done
	+ ~Global("kla#book01","GLOBAL",5)
		!GlobalTimerNotExpired("kla#book01Timer","GLOBAL")~
		+ @56 DO ~SetGlobal("kla#book01","GLOBAL",12)~ + madeProgress
	// doghma knows not, player does, book not fully charged
	+ ~PartyHasItem("kla#bk01")
		...
		+ @57 DO ~IncrementGlobal("kla#book01","GLOBAL",2)~ + tellAboutBook
	// doghma knows, book not fully charged
	+ ~PartyHasItem("kla#bk01")
		!GlobalGT("kla#book01Charge","GLOBAL",95)
		OR(8)
			Global("kla#book01","GLOBAL",12)
	...
	+ ~PartyHasItem("kla#bk01")
		...
		OR(8)
			...
			Global("kla#book01","GLOBAL",25)~
		+ @59 + dealA
	// doghma knows, book fully charged, full magic
	+ ~PartyHasItem("kla#bk01")
		GlobalGT("kla#book01Charge","GLOBAL",95)
		...
		OR(8)
			...
			Global("kla#book01","GLOBAL",25)~
		+ @59 + dealB
	// doghma knows, book fully charged, half magic
	+ ~PartyHasItem("kla#bk01")
		GlobalGT("kla#book01Charge","GLOBAL",95)
		!GlobalGT("kla#book01Points","GLOBAL",95)
		...
		OR(8)
			...
			Global("kla#book01","GLOBAL",25)~
		+ @59 + dealC
	// doghma knows, book fully charged, some magic
	+ ~PartyHasItem("kla#bk01")
		GlobalGT("kla#book01Charge","GLOBAL",95)
		!GlobalGT("kla#book01Points","GLOBAL",47)
		...
		OR(8)
			...
			Global("kla#book01","GLOBAL",25)~
		+ @59 + dealD
	// doghma knows, book fully charged, no magic
	+ ~PartyHasItem("kla#bk01")
		GlobalGT("kla#book01Charge","GLOBAL",95)
		!GlobalGT("kla#book01Points","GLOBAL",5)
		OR(8)
