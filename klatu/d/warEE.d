...
IF ~~ bookWeaponChoice
	...
	+ ~!CheckStatGT(LastTalkedToBy, 0, PROFICIENCYCLUB)~ + @91 DO ~ActionOverride(LastTalkedToBy,ApplySpellRES("kla#bk91", Myself))~ + bookWeaponProficient
	+ ~CheckStat(LastTalkedToBy, 1, PROFICIENCYCLUB)~ + @91 DO ~ActionOverride(LastTalkedToBy,ApplySpellRES("kla#bk92", Myself))~ + bookWeaponSpecialized
	+ ~CheckStat(LastTalkedToBy, 2, PROFICIENCYCLUB)~ + @91 DO ~ActionOverride(LastTalkedToBy,ApplySpellRES("kla#bk93", Myself))~ + bookWeaponMaster
	+ ~CheckStat(LastTalkedToBy, 3, PROFICIENCYCLUB)~ + @91 DO ~ActionOverride(LastTalkedToBy,ApplySpellRES("kla#bk94", Myself))~ + bookWeaponHighMaster
	+ ~CheckStat(LastTalkedToBy, 4, PROFICIENCYCLUB)~ + @91 DO ~ActionOverride(LastTalkedToBy,ApplySpellRES("kla#bk95", Myself))~ + bookWeaponGrandMaster
